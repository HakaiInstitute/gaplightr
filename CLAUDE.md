...
**gaplightr** is an R package currently in early development (version 0.0.0.9000).
...
- Use `usethis::use_package("package_name")` to add dependencies to DESCRIPTION
- Use `usethis::use_package("package_name", "Suggests")` for suggested packages
- Reference external functions with `::` (e.g., `dplyr::filter()`) or import in NAMESPACE

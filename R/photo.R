...
#'   asymptotic lower bound approached as distance increases. Default is 0.04.
#' @param pointsize Point size parameter for bitmap graphics device. Default is 20.
#' @param dpi Resolution in dots per inch for output image. Default is 1200.
